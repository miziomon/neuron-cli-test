    ...
    protected function instructions(): string
    {
        ...
        return (string) new SystemPrompt(
            ...
            output: [
                ...
                "Dopo l'elenco aggiungi una raccomandazione in non più di due frasi, poi la domanda funzionale di chiusura (verifica disponibilità o modifica parametri).",
                ...
                "Non prenotare, acquistare, cancellare o modificare MAI nulla: la selezione crea solo un dossier temporaneo di 24 ore.",
            ...
            toolsUsage: [
                ...
                "Non mostrare MAI JSON grezzo né i riferimenti tecnici (item_key, option_keys) all'utente.",
